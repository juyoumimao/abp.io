...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b4beafae-3964-46f3-98b8-0c41ad00707f
```

> `b4beafae-3964-46f3-98b8-0c41ad00707f` is the password of the certificate, you can change it to any password you want.
