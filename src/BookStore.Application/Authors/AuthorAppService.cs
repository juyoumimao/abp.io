...
namespace BookStore.Authors
{
    ...
    public class AuthorAppService : BookStoreAppService, IAuthorAppService
    {
        ...
        public async Task<ResultDto<AuthorDto>> CreateAsync(CreateAuthorDto input)
        {
            ...
            return ResultDto < AuthorDto >.Success(ResultCode.Ok, ObjectMapper.Map<Author, AuthorDto>(author));
        ...
        public async Task<PagedResultDto<AuthorDto>> GetListAsync(GetAuthorListDto input)
        {
            ...
            PagedResultDto<AuthorDto> res = new PagedResultDto<AuthorDto>()
            {
                TotalCount = totalCount,

            };
            var dto = ObjectMapper.Map<List<Author>, List<AuthorDto>>(authors);
